...
def learner_setup(
    ...
    actor_action_head = hydra.utils.instantiate(
        ...
        is_central_controller=config.system.is_central_controller,
...
def run_experiment(_config: DictConfig) -> float:
    """Runs experiment."""
    _config.logger.system_name = "rec_ppo_central"
...
@hydra.main(
    ...
    config_name="rec_ppo_central.yaml",
    version_base="1.2",
)
def hydra_entry_point(cfg: DictConfig) -> float:
    ...
    try:
        ...
        print(
            f"{Fore.CYAN}{Style.BRIGHT}Recurrent Central PPO experiment completed{Style.RESET_ALL}"
        )
    except Exception as e:
        print(
            f"{Fore.RED}{Style.BRIGHT}Recurrent Central PPO experiment failed: {e}{Style.RESET_ALL}"
        )
