...
def learner_setup(
    ...
    actor_network = AutoregressiveTabularPolicy(
...
def run_experiment(_config: DictConfig) -> float:
    """Runs experiment."""
    _config.logger.system_name = "ff_ppo_central_autoreg_tabular"
...
@hydra.main(
    ...
    config_name="ff_ppo_central_autoreg_tabular.yaml",
    version_base="1.2",
)
def hydra_entry_point(cfg: DictConfig) -> float:
    ...
    print(
        f"{Fore.CYAN}{Style.BRIGHT}Central PPO Autoregressive Tabular experiment completed{Style.RESET_ALL}"
    )
    return eval_performance
