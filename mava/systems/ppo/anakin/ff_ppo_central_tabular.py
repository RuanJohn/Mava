...
from mava.networks.heads import TabularPolicy
...
def learner_setup(
    ...
    actor_network = TabularPolicy(num_agent=1, num_actions=num_actions)
...
def run_experiment(_config: DictConfig) -> float:
    """Runs experiment."""
    _config.logger.system_name = "ff_ppo_central_tabular"
...
@hydra.main(
    ...
    config_name="ff_ppo_central_tabular.yaml",
    version_base="1.2",
)
